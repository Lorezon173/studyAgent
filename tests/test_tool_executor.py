...
def test_execute_retrieval_tools_obeys_explicit_tool_plan(monkeypatch):
    ...
    rows, used_tools = execute_retrieval_tools(
        ...
        topic="二分查找",
        user_id=123,
        tool_route={"tool": "search_local_textbook", "tool_plan": ["search_web"]},
...
def test_execute_retrieval_tools_without_explicit_plan_uses_tool_route_plan(monkeypatch):
    called_tools: list[str] = []
    ...
    rows, used_tools = execute_retrieval_tools(
        ...
        topic="二分查找",
        user_id=123,
        tool_route={"tool": "search_local_textbook", "tool_plan": ["search_personal_memory"]},
        tool_plan=None,
        top_k=3,
    )
...
def test_execute_retrieval_tools_with_route_empty_plan_runs_nothing(monkeypatch):
    called_tools: list[str] = []
    ...
    rows, used_tools = execute_retrieval_tools(
        ...
        topic="二分查找",
        user_id=123,
        tool_route={"tool": "search_local_textbook", "tool_plan": [None, "", "  "]},
        tool_plan=None,
        top_k=3,
    )
